...
class JPJinfo extends Controller
{
    ...
    public function semaksaman() //check balik
    {
    ...
    public function semakan_tarikh_luput_lesen_kenderaan_motor()
    {
        $postdata = file_get_contents("php://input");
    ...
    public function semakan_nombor_pendaftaran()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
        $areaCode = strtoupper($request->kod);
        ...
        $bil = $doc->getElementsByTagName('vehicleRegnoInfo')->length;
        echo json_encode([
            'status' => 200,
            'stateName' => $areaName,
            'velno' => $regnNo,
    ...
    public function semakan_status_permohonan_penubuhan_institut_memandu()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
    ...
    public function semakan_tarikh_luput_lesen_memandu()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
        $nokp = $request->nokp;
    ...
    public function semakan_status_senarai_hitam()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
        $icno = $request->nokp;
    ...
    public function semakan_dimerit()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
        $icno = $request->nokp;
    ...
    public function semakan_pertukaran_lesen_memandu_luar_negara()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
        $icno = $request->icno;
    ...
    public function semakan_ujian_memandu()
    {
        $postdata = file_get_contents("php://input");
        $request = json_decode($postdata);
        $icNo = $request->nokp;
