...
Route::post('/store_notification', [JpjMobileApiController::class, 'store_pm']);
Route::post('/update_notification', [JpjMobileApiController::class, 'upd_pm']);
...
//added by JPJ to login to JPJInfo
Route::post('/aduantrafikmobile/login/processlogin2', [JpjInfoTempController::class, 'login']);
Route::post('/aduantrafikmobile/login/processlogin3', [JpjInfoTempController::class, 'login3']);